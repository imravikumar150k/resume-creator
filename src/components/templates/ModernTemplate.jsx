...
const ModernTemplate = forwardRef(function ModernTemplate({ data, accentColor = '#2563eb' }, ref) {
    ...
    <div ref={ref} className="resume-preview bg-white p-8 print:p-0 max-w-[8.5in] mx-auto font-sans text-sm leading-relaxed">
      ...
      {summary && (
        <section className="mb-5">
          <h2 className="text-sm font-bold uppercase text-gray-800 pb-1 mb-2" style={{ borderBottom: `2px solid ${accentColor}` }}>Summary</h2>
      ...
      {experience.length > 0 && experience.some((e) => e.title || e.company) && (
        <section className="mb-5">
          <h2 className="text-sm font-bold uppercase text-gray-800 pb-1 mb-2" style={{ borderBottom: `2px solid ${accentColor}` }}>Experience</h2>
      ...
      {education.length > 0 && education.some((e) => e.degree || e.institution) && (
        <section className="mb-5">
          <h2 className="text-sm font-bold uppercase text-gray-800 pb-1 mb-2" style={{ borderBottom: `2px solid ${accentColor}` }}>Education</h2>
          {education.map((entry) => (
      ...
      {skills.length > 0 && (
        <section className="mb-5">
          <h2 className="text-sm font-bold uppercase text-gray-800 pb-1 mb-2" style={{ borderBottom: `2px solid ${accentColor}` }}>Skills</h2>
      ...
      {projects.length > 0 && projects.some((p) => p.name) && (
        <section className="mb-5">
          <h2 className="text-sm font-bold uppercase text-gray-800 pb-1 mb-2" style={{ borderBottom: `2px solid ${accentColor}` }}>Projects</h2>
          {projects.map((entry) => (
            entry.name && (
              <div key={entry.id} className="mb-2">
