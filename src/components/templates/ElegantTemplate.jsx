...
const ElegantTemplate = forwardRef(function ElegantTemplate({ data }, ref) {
  ...
  return (
    <div ref={ref} className="resume-preview bg-white p-8 print:p-0 max-w-[8.5in] mx-auto font-serif text-sm leading-relaxed">
      <header className="text-center mb-5 pb-4 border-b-2 border-amber-600">
      ...
      {summary && (
        <section className="mb-4">
          <h2 className="text-xs font-bold uppercase tracking-[0.2em] text-amber-700 mb-2">Profile</h2>
      ...
      {experience.length > 0 && experience.some((e) => e.title || e.company) && (
        <section className="mb-4">
          <h2 className="text-xs font-bold uppercase tracking-[0.2em] text-amber-700 mb-2">Experience</h2>
      ...
      {education.length > 0 && education.some((e) => e.degree || e.institution) && (
        <section className="mb-4">
          <h2 className="text-xs font-bold uppercase tracking-[0.2em] text-amber-700 mb-2">Education</h2>
          {education.map((entry) => (
      ...
      {skills.length > 0 && (
        <section className="mb-4">
          <h2 className="text-xs font-bold uppercase tracking-[0.2em] text-amber-700 mb-2">Skills</h2>
      ...
      {projects.length > 0 && projects.some((p) => p.name) && (
        <section className="mb-4">
          <h2 className="text-xs font-bold uppercase tracking-[0.2em] text-amber-700 mb-2">Projects</h2>
          {projects.map((entry) => (
            entry.name && (
              <div key={entry.id} className="mb-2">
